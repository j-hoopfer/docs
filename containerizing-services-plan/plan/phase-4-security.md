...
Proceed to [Phase 3: Infrastructure Setup](../../ec2-to-ecs-brownfield-migration-plan/plan/phase-3-infrastructure-setup.md) in the main migration plan to deploy to ECS Fargate.
