...
**Key Point:** One S3 bucket per account, organized by the `key` path. See [Phase 8: Next Steps](8-next-steps.md) for detailed downstream project setup

---

## Getting Started

Ready to begin? Start with [Phase 0: Prerequisites](0-prerequisites.md) and follow the phases in order

---

## Additional Resources

- **[0-prerequisites.md](0-prerequisites.md)** - Install Terraform, AWS CLI, configure AWS SSO (macOS/Windows/Linux)
- **[1-repository-setup.md](1-repository-setup.md)** - Repository initialization and Git configuration
- **[2-terraform-module.md](2-terraform-module.md)** - Terraform state backend module creation
- **[3-bootstrap-dev.md](3-bootstrap-dev.md)** - Dev account bootstrap
- **[4-bootstrap-ci.md](4-bootstrap-ci.md)** - Continuous Integration (validation workflows)
- **[5-bootstrap-prod.md](5-bootstrap-prod.md)** - Prod account bootstrap
- **[6-migrate-to-remote-state.md](6-migrate-to-remote-state.md)** - Optional state migration (flexible ordering - dev before prod is OK)
- **[7-bootstrap-cd.md](7-bootstrap-cd.md)** - Optional: Automated deployment with OIDC
- **[8-next-steps.md](8-next-steps.md)** - What to do after bootstrap completion
