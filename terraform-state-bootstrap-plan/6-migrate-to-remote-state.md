...
- [Phase 3 - Bootstrap Dev](3-bootstrap-dev.md) **required** (to migrate dev account)
- [Phase 5 - Bootstrap Prod](5-bootstrap-prod.md) **optional** (only needed if migrating prod account)
...
**Previous Phase:** [Phase 5 - Bootstrap Prod Account](5-bootstrap-prod.md)  
**Next Phase (Optional):** [Phase 7 - Downstream CI/CD Integration](7-bootstrap-cd.md) - Set up OIDC for infrastructure projects
