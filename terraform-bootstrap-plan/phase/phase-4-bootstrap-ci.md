...
**Previous Phase:** [Phase 3 - Bootstrap Dev Account](phase-3-bootstrap-dev.md) must be completed
    ...
    steps:
      ...
      - name: TFLint Failed
        ...
        run: |
          ...
          echo "Run locally: tflint --recursive"
          echo "Common issues:"
          echo "  - Deprecated syntax"
          echo "  - Invalid resource references"
          echo "  - AWS-specific misconfigurations"
...
**Next Phase:** [Phase 5 - Bootstrap Prod Account](phase-5-bootstrap-prod.md)
