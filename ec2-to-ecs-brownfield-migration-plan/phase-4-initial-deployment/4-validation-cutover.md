# Activity 4: Validation & Cutover

**Goal:** Execute the specific test plan to verify parity between the new Fargate service and the old EC2 service before fully cutting over DNS or increasing traffic weight.

## Context & Themes

Zero-downtime cutover requires trust. This activity validates that the new stack matches the old stack in behavior, performance, and access before putting customers on it.

**Key Themes:**

- **Parity Testing:** Ensuring functional equivalence.
- **Rollback Readiness:** Preparing for immediate reversion.
- **Confidence Building:** Validating the new platform.

### Prerequisites

- [ ] [Traffic Routing](3-traffic-routing.md) configured (available at test domain/header).
- [ ] Test scripts or manual checklist prepared.

## Feature 4: Validation Strategy
