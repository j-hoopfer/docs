...
- See [aws-authentication-and-security.md](../../phase-3-infrastructure-setup/appendix/aws-authentication-and-security.md) for OIDC setup
- See [ecs-deployment-fundamentals.md](ecs-deployment-fundamentals.md) for understanding ECS concepts
- See [troubleshooting-and-operations.md](../../phase-5-scaling/appendix/troubleshooting-and-operations.md) for debugging pipelines
