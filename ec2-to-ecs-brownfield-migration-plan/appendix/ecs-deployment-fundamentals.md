...
- See [networking-and-security-groups.md](networking-and-security-groups.md) for security group patterns
- See [github-actions-cicd.md](github-actions-cicd.md) for deployment automation
- See [troubleshooting-and-operations.md](troubleshooting-and-operations.md) for debugging failed deployments
