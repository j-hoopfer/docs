...
- See [ecs-deployment-fundamentals.md](ecs-deployment-fundamentals.md) for understanding task definitions
- See [github-actions-cicd.md](github-actions-cicd.md) for secrets vs configuration in pipelines
