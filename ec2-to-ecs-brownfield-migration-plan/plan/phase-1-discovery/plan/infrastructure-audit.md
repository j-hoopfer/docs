...
**Goal:** systematic review of the existing AWS environment to identify network barriers, data store dependencies, and security group constraints that must be addressed before Fargate deployment.
...
## Feature 2: Security Group Planning & Data Stores
...
## Feature 3: Service Quotas & Limits
...
### Story 3.1: Check AWS Service Quotas
...
### Story 4.1: Estimate Fargate Migration Costs
...
### Story 4.2: Audit EC2 Reserved Instances and Savings Plans
