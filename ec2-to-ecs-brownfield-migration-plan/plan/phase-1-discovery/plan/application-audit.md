...
**Goal:** Detailed inventory of the running application state on EC2, ensuring that all hidden dependencies (local files, cron jobs, agents, internal traffic) are documented before containerization begins.
...
### Story 1.2: Audit Current Logging Setup and Consumers
...
### Story 1.3: Audit Host-Level Agents and APM Tools
