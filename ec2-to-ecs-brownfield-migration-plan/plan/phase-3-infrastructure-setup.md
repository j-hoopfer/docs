...
This phase imports existing infrastructure into Terraform and provisions new AWS resources for Fargate. The goal is to bring existing EC2, RDS, and network infrastructure under Terraform management, then build new Fargate resources alongside them.
...
## Feature 2: Terraform State Management (If Not Completed in Phase -1)

**Note:** If you already completed Story 3.2 in Phase -1 (Bootstrap Terraform State Backend), skip this feature and proceed to Feature 3.

**Before provisioning any new infrastructure, you must have remote Terraform state management configured.** This ensures state is durable, encrypted, and team-accessible.
