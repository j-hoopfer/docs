...
- [ ] Branch protection enabled on `main` branch
- [ ] **Terraform state backend configured** (via [Terraform Bootstrap Plan](../../../terraform-bootstrap-plan/README.md))
- [ ] S3 bucket and DynamoDB table names documented in repository README
