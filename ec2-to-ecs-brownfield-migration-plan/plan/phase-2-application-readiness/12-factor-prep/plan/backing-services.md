...
**Prerequisites:** [Observability](observability.md) completed

**Next Phase:** [Network & Security](network-and-security.md)

---

## Story 1: Replace Local Mail Agent with Cloud Email Service
...
Before proceeding to [Network & Security](network-and-security.md) phase:
