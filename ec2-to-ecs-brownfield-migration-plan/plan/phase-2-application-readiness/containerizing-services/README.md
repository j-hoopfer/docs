...
- **Optional:** [CI/CD for Containers Plan](../cicd-for-containers-plan/) - Automate image builds (skip if you have CI/CD)
- **Foundation:** [Terraform Bootstrap Plan](../terraform-bootstrap-plan/) - Terraform state backend
- **Reference:** [Greenfield Containerization Stories](plan/greenfield-containerization-stories.md) - Original source material from ECS Greenfield MVP Plan (integrated into phases above)
...
- [Story 1: Create Production-Ready Dockerfile](plan/phase-1-docker-packaging/dockerfile-basics.md#story-1)
- [Story 2: Configure Network Binding and Port Exposure](plan/phase-1-docker-packaging/dockerfile-basics.md#story-2)
- [Story 3: Build Multi-Architecture Container Images](plan/phase-1-docker-packaging/dockerfile-basics.md#story-3)
- [Story 4: Establish Local Development Parity with docker-compose](plan/phase-1-docker-packaging/local-development.md)
- [Story 5: Add Native Health Check to Dockerfile](plan/phase-1-docker-packaging/dockerfile-basics.md#story-4)
...
- [Story 1: Configure PID 1 and Signal Handling](plan/phase-2-container-lifecycle/container-lifecycle.md#story-1)
- [Story 2: Implement Graceful Shutdown](plan/phase-2-container-lifecycle/container-lifecycle.md#story-2)
...
- [Story 1: Optimize Container Startup Time](plan/phase-3-optimization/optimization.md#story-1)
- [Story 2: Configure Resource Limits](plan/phase-3-optimization/optimization.md#story-2)
...
- [Story 1: Run Containers as Non-Root User](plan/phase-4-security/container-security.md#story-1)
- [Story 2: Implement Image Scanning](plan/phase-4-security/container-security.md#story-2)
- [Story 3: Implement Secrets Management (Validation)](plan/phase-4-security/container-security.md#story-3)
- [Story 4: Read-Only Root Filesystem](plan/phase-4-security/container-security.md#story-4)
